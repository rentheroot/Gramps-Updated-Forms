...
class MultiSection(Gtk.Box):
    ...
    def save(self, trans):
        ...
        for order, row in enumerate(self.model):
            ...
            self.EventManager.get_linked_event_status(event_creation_rules,
                                                      note_handle,
                                                      linked_events,
                                                      person,
                                                      self.db,
            ...
            # Get Updated Note of Linked Events
            updated_note = self.db.get_note_from_handle(note_handle)
            linked_events = json.loads(str(updated_note.get_styledtext()))
